def test_create_deploy_argument_simple(FACTORY, TYPES, vector_cl_types):
...
def test_create_deploy_argument_byte_array(FACTORY, TYPES, vector_cl_types):
...
def test_create_deploy_argument_list(FACTORY, TYPES, vector_cl_types):
...
def test_create_deploy_argument_map(FACTORY, TYPES, vector_cl_types):
...
def test_create_deploy_argument_tuple_1(FACTORY, TYPES, vector_cl_types):
...
def test_create_deploy_argument_tuple_2(FACTORY, TYPES, vector_cl_types):
...
def test_create_deploy_argument_tuple_3(FACTORY, TYPES, vector_cl_types):
