...
def test_that_a_standard_payment_can_be_encoded_as_bytes(FACTORY, vector_deploy_1):
...
def test_that_a_standard_transfer_session_can_be_encoded_as_bytes(FACTORY, vector_deploy_1):
    for vector in [v for v in vector_deploy_1 if v["typeof"] == "transfer"]:
...
def test_that_a_deploy_can_be_encoded_as_bytes(FACTORY, deploy_params_static, vector_deploy_1):
    for vector in [v for v in vector_deploy_1 if v["typeof"] == "transfer"]:
