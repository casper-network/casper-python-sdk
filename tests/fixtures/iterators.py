...
def yield_cl_types(fixtures: list) -> typing.Iterator[CL_Type]:
    for fixture in fixtures:
        ...
        if type_key == CL_TypeKey.ANY:
            ...
            yield types.CL_Type_Option(types.CL_Type_Tuple1(types.CL_Type_U64()))
            yield types.CL_Type_Option(types.CL_Type_Tuple2(types.CL_Type_U64(), types.CL_Type_U128()))
            yield types.CL_Type_Option(types.CL_Type_Tuple3(types.CL_Type_U64(), types.CL_Type_U128(), types.CL_Type_U256()))
