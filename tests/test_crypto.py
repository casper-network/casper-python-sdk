...
def test_get_public_key_from_private_key_1(LIB, vector_crypto_2):
...
def test_get_public_key_from_private_key_2(LIB, vector_crypto_2):
...
def test_get_public_key_from_private_key_3(LIB, vector_crypto_2):
