...
def _encode_transfer(instance: ExecutionInfo_Transfer) -> bytearray:
    return cl.encode(CLTypeKey.LIST, instance.args, deploy_named_arg.encode)
...
def to_bytes(instance: ExecutionInfo) -> bytearray:
