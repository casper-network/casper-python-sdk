...
def _encode_transfer(instance: DeployExecutable_Transfer) -> bytearray:
    return cl.encode(CLType.LIST, instance.args, deploy_named_arg.encode)
...
def to_bytes(instance: DeployExecutable) -> bytearray:
    ...
    """
    return [_TYPE_TAGS[type(instance)]] + _ENCODERS[type(instance)](instance)
