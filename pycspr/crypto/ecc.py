...
def get_key_pair_from_base64(pvk_b64: str, algo: KeyAlgorithm = KeyAlgorithm.ED25519) -> typing.Tuple[bytes, bytes]:
...
def get_key_pair_from_pem_file(fpath: str, algo: KeyAlgorithm = KeyAlgorithm.ED25519) -> typing.Tuple[bytes, bytes]:
