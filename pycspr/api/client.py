...
class NodeClient():
    ...
    def __init__(self, connection_info: NodeConnectionInfo):
        ...
        self.get_node_metric = self._rest_client.get_node_metric
        ...
        self.get_account_main_purse_uref = self._rpc_client.get_account_main_purse_uref
        self.get_account_named_key = self._rpc_client.get_account_main_purse_uref
        self.get_auction_info = self.get_auction_state = self._rpc_client.get_auction_info
        self.get_block = self._rpc_client.get_block
        self.get_block_at_era_switch = self._rpc_client.get_block_at_era_switch
        self.get_block_height = self._rpc_client.get_block_height
        self.get_block_transfers = self._rpc_client.get_block_transfers
        self.get_chain_heights = self._rpc_client.get_chain_heights
        ...
        self.get_era_height = self._rpc_client.get_era_height
        ...
        self.get_rpc_endpoint = self._rpc_client.get_rpc_endpoint
        self.get_rpc_endpoints = self._rpc_client.get_rpc_endpoints
        ...
        self.await_n_blocks = self._sse_client.await_n_blocks
        self.await_n_eras = self._sse_client.await_n_eras
        self.await_n_events = self._sse_client.await_n_events
        self.await_until_block_n = self._sse_client.await_until_block_n
        self.await_until_era_n = self._sse_client.await_until_era_n
        self.get_events = self._sse_client.get_events
