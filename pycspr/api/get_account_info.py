...
def execute(node: NodeConnectionInfo, account_key: typing.Union[bytes, str],
            block_id: typing.Union[None, bytes, str, int] = None) -> dict:
    """
    Returns on-chain account information at a certain state root hash.

    :param node: Information required to connect to a node.
    :param account_key: An account holder's public key prefixed with a key type
                        identifier.
...
def get_params(account_key: typing.Union[bytes, str],
               block_id: typing.Union[None, str, int] = None) -> dict:
    """
