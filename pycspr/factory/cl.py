...
def create_cl_type_of_list(inner_type: CLType) -> CLType_List:
    ...
    :param CLType inner_type: Type information pertaining to each element
                               within list.
    """
...
def create_cl_type_of_map(key_type: CLType, value_type: CLType) -> CLType_Map:
    ...
    :param CLType key_type: Type information pertaining to each key within
                            the map.
    :param CLType value_type: Type information pertaining to each value
                              within the map.
    """
...
def create_cl_type_of_option(inner_type: CLType):
    """Returns CL type information for a byte array.
    :param CLType inner_type: Type information pertaining to the
                              optional value.
    """
...
def create_cl_type_of_storage_key(key_type: CLStorageKeyType
                                  ) -> CLType_StorageKey:
    """Returns CL type information for a storage key.
    :param CLStorageKeyType key_type: Type information pertaining
                                      to storage key.
    """
...
def create_cl_type_of_tuple_3(t0_type: CLType, t1_type: CLType,
                              t2_type: CLType):
    """Returns CL type information for a byte array.
    :param CLType t0_type: Type information pertaining to first tuple element.
    :param CLType t1_type: Type information pertaining to second tuple element.
