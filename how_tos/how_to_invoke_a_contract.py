...
# CLI argument: path to user to whom tokens will be transferred - defaults
#               to NCTL user 1.
_ARGS.add_argument(
...
def _get_contract_hash(args: argparse.Namespace, client: NodeClient,
    ...
    # We query operator account for a named key == ERC20, we then return the
